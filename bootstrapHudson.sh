...
then
        ...
        java15-home="/shared/common/ibm-java2-ppc64-50/jre"
else
        buildLaunching15VM="/shared/common/jdk-1.5.0-22.x86_64/jre/bin"
        java15-home="/shared/common/jdk-1.5.0-22.x86_64/jre"
fi
