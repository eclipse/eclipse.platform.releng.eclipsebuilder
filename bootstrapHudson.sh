...
echo org.eclipse.equinox.p2.tests.current.build.repo=https://hudson.eclipse.org/hudson/job/$JOB_NAME/$BUILD_NUMBER/artifact/builds/transfer/files/repo/$buildId >> $WORKSPACE/test.properties 
