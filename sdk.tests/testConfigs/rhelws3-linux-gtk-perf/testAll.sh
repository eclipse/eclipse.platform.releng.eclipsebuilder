...
./runtests -os linux -ws gtk -arch x86 -vm ../jdk1.4.2_03/jre/bin/java -properties vm.properties -Dtest.target=performance -Dplatform=linux.gtk.perf> linux.gtk.perf_consolelog.txt
