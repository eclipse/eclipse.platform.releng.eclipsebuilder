...
./runtests -os linux -ws gtk -arch x86 -vm ../jdk1.4.2_06/jre/bin/java -properties vm.properties -DtestTarget=performance -Dplatform=linux.gtk.perf> linux.gtk.perf_consolelog.txt
