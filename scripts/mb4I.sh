...
# Debug version
#DEBUG=true $buildRoot/masterBuild.sh -buildType I -eclipseStream 4.2 -buildRoot $buildRoot  2>&1 | tee fullmasterBuildOutput.txt

# production, routine version
$buildRoot/masterBuild.sh -buildType I -eclipseStream 4.2 -buildRoot $buildRoot
