...
<head>
	...
	<link rel="stylesheet" type="text/css" href="stylesheets/visual.css" media="screen" />
...
<div id="header">
	<a href="/"><img src="stylesheets/header_logo.gif" width="163" height="68" border="0" alt="Eclipse Logo" class="logo" /></a>
	<div id="searchbar">
		<img src="stylesheets/searchbar_transition.gif" width="92" height="26" class="transition" alt="" />
		<img src="stylesheets/searchbar_header.gif" width="64" height="17" class="header" alt="Search" />
		<form method="get" action="/search/search.cgi">
			...
			<input type="image" class="button" src="stylesheets/searchbar_submit.gif" alt="Submit" onclick="this.submit();" />
		</form>
	</div>
	<ul id="headernav">
...
<li><a href="#org.eclipse.releng">org.eclipse.releng.tools plug-in</a></li>
  ...
  <li style="background-image: url(stylesheets/leftnav_fade.jpg); background-repeat: repeat-x; border-style: none;">
			<br /><br /><br /><br /><br />
  </li>
</ul>
