...
%vmcmd% -XshowSettings -Xbootclasspath/p:D:\shared\xalan\java_cup.runtime_0.10.0.v201005080400.jar;D:\shared\xalan\org.apache.bcel_5.2.0.v201005080400.jar;D:\shared\xalan\javax.xml_1.3.4.v201005080400.jar;D:\shared\xalan\org.apache.xerces_2.9.0.v201101211617.jar;D:\shared\xalan\org.apache.xalan_2.7.1.v201005080400.jar;D:\shared\xalan\org.apache.xml.serializer_2.7.1.v201005080400.jar -Djavax.xml.transform.TransformerFactory=org.apache.xalan.processor.TransformerFactoryImpl -Dosgi.os=%os% -Dosgi.ws=%ws% -Dosgi.arch=%arch% -jar eclipse\plugins\%launcher-jar% -data workspace -application org.eclipse.ant.core.antRunner -file test.xml %tests% -Dws=%ws% -Dos=%os% -Darch=%arch%  -D%installmode%=true %properties% -logger org.apache.tools.ant.DefaultLogger
