...
#all tests
./runtests -os linux -ws gtk -arch x86 -vm `pwd`/../jdk1.4.2_10/jre/bin/java -properties vm.properties -Dtest.target=performance -Dplatform=linux.gtk.perf2 1> linux.gtk.perf2_consolelog.txt 2>&1
