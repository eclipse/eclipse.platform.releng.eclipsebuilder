...
#all tests
./runtests -os linux -ws gtk -arch x86 -vm `pwd`/../jdk1.5.0_14/jre/bin/java -properties vm.properties -Dtest.target=performance -Dplatform=linux.gtk.perf1 1> linux.gtk.perf1_consolelog.txt 2>&1
