...
#all tests
./runtests -os linux -ws gtk -arch x86 -vm ../jdk1.4.2_10/jre/bin/java -properties vm.properties -Dtest.target=performance -Dplatform=linux.gtk.perf -Dskip.jdttext=true> linux.gtk.perf_consolelog.txt
