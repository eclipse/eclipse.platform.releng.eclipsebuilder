...
#all tests
./runtests -os linux -ws gtk -arch x86 -vm `pwd`/../jdk6_04/jre/bin/java -properties vm.properties -Dtest.target=performance -Dplatform=linux.gtk.perf3 1> linux.gtk.perf3_consolelog.txt 2>&1
